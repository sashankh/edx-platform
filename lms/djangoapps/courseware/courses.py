        ...
        try:
            ...
            if about_module is not None:
                try:
                    ...
                    log.exception(u"Error rendering course={course}, section_key={section_key}".format(
                        course=course,
            ...
            log.warning(u"Missing about section {key} in course {url}".format(
...
def get_course_syllabus_section(course, section_key):
    ...
    if section_key in ['syllabus', 'guest_syllabus']:
        try:
            ...
            log.exception(u"Missing syllabus section {key} in course {url}".format(
                key=section_key, url=course.location.url()
            ))
